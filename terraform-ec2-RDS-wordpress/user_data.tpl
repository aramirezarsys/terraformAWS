...
wp config create --allow-root --dbname=$db_name --dbuser=$db_username --dbpass=$db_user_password --dbhost=$db_RDS --locale=en_DB --dbprefix=whebfubwef_ --path=/var/www/html --extra-php <<PHP
define( 'FS_METHOD', 'direct' );
define('WP_MEMORY_LIMIT', '128M');
PHP
