...
wp config create --allow-root --dbname=$db_name --dbuser=$db_username --dbpass=$db_user_password --dbhost=$db_RDS --dbprefix=whebfubwef_ --locale=en_DB --path=/var/www/html --extra-php <<PHP
define( 'FS_METHOD', 'direct' );
define('WP_MEMORY_LIMIT', '128M');
PHP
# wp user create aramirez aramirez@arsys.es --role=administrator --user_pass=252bd6772f7e85040c01ee5d5091eeb8
wp core install --url=http://arsys.es --title=WordPressTitle --admin_user=aramirez --admin_password=asdASD123qweQWE --admin_email=aramirez@arsys.es
wp core update
